...
@router.get("", response_model=ListOfArticlesInResponse, name="operations:list-operations")
...
@router.post(
    ...
    name="operations:create-article",
)
...
@router.get("/{slug}", response_model=ArticleInResponse, name="operations:get-article")
...
@router.put(
    "/{slug}",
    response_model=ArticleInResponse,
    name="operations:update-article",
...
@router.delete(
    ...
    name="operations:delete-article",
    dependencies=[Depends(check_article_modification_permissions)],
